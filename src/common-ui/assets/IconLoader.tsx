const IconLoader = () => (
  ...
  >
    <defs id="defs">
      ...
      <symbol id="message-green" viewBox="0 0 21 20">
        <path
          fill="#A7E100"
          d="M18.5 0h-16C1.4 0 .51.9.51 2L.5 20l4-4h14c1.1 0 2-.9 2-2V2c0-1.1-.9-2-2-2Zm-2 12h-12v-2h12v2Zm0-3h-12V7h12v2Zm0-3h-12V4h12v2Z"
        />
      </symbol>

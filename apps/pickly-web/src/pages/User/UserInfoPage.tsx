...
import useHandleInput from '@/shared/common/service/useHandleInput';
import useAuthStore from '@/shared/store/auth';

import { 특수문자_제거, 특수문자_확인 } from '@/shared/utils/check';
import useToast from '@/shared/ui/Toast/hooks/useToast';
import { BottomFixedButton, Header } from '@pickly/design-system';
import UserProfileInfo from '@/widgets/user/ui/UserProfileInfo';
import { usePutUserInfoQuery } from '@/widgets/user/api/user';
